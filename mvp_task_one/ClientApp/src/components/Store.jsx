...
export class Store extends Component {
    ...
    render() {
        ...
        return (
            <div id='container'>
                 <CreateStore  getDataCreate={this.getData} />
                <Table id='table' celled className='ui table striped' aria-labelledby="tabelLabel">
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.HeaderCell onClick={this.onSort('address')}><span class="sort">Address</span><div className={this.setArrow('address')}></div></Table.HeaderCell>
                    ...
                    <Table.Body>          
                        ...
                        return (
                            <Table.Row>
                                ...
                                <Table.Cell><EditStore  getDataEdit={this.getData} editData={item} /></Table.Cell>
                                <Table.Cell><DeleteStore getDataDelete={this.getData}  deleteId={item.id} /> </Table.Cell>
                            </Table.Row> 
                        );
                        })}
                    </Table.Body>
