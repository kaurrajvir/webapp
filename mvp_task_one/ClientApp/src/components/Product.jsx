...
export class Product extends Component {
    ...
    render() {
        ...
        return (
            <div id='container'>
                 <CreateProduct  getDataCreate={this.getData} />
                <Table id='table' celled className='ui table striped' aria-labelledby="tabelLabel">
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.HeaderCell onClick={this.onSort('price')}><span class="sort">Price</span><div className={this.setArrow('price')}></div></Table.HeaderCell>
                    ...
                    <Table.Body>          
                        ...
                        return (
                            <Table.Row>
                                ...
                                <Table.Cell><EditProduct  getDataEdit={this.getData} editData={item} /></Table.Cell>
                                <Table.Cell><DeleteProduct getDataDelete={this.getData}  deleteId={item.id} /> </Table.Cell>
                            </Table.Row> 
                        );
                        })}
                    </Table.Body>
